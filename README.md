...
# │   └── 01\_date\_fruit\_ann\_classification.ipynb
...
# │   ├── training\_validation\_accuracy.png

# │   └── training\_validation\_loss.png
...
| `class\\\_distribution.png` | Class distribution visualization |

| `training\\\_validation\\\_accuracy.png` | Training and validation accuracy plot |

| `training\\\_validation\\\_loss.png` | Training and validation loss plot |

| `confusion\\\_matrix.png` | Confusion matrix heatmap |

| `classification\\\_report.csv` | Class-level precision, recall, and F1-score |

| `summary\\\_results.csv` | Summary of main evaluation metrics |
...
notebooks/01\\\_date\\\_fruit\\\_ann\\\_classification.ipynb
